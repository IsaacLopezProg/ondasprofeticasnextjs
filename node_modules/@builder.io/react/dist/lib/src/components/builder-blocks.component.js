...
var BuilderBlocks = /** @class */ (function (_super) {
    ...
    BuilderBlocks.prototype.render = function () {
        ...
        core_1.jsx(TagName, __assign({ className: 'builder-blocks' +
            ...
            blocks.map(function (block, index) {
                return block && block['@type'] === '@builder.io/sdk:Element' ? (core_1.jsx(builder_block_component_1.BuilderBlock, { key: block.id, block: block, index: index, fieldName: _this.props.fieldName, child: _this.props.child, emailMode: _this.props.emailMode })) : (block);
            })) ||
            blocks));
    };
