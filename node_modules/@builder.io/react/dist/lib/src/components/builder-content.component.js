...
var BuilderContent = /** @class */ (function (_super) {
    ...
    function BuilderContent() {
        ...
        _this.state = {
            ...
            data: exports.getContentWithInfo(_this.props.content),
            updates: 1,
        };
    ...
    Object.defineProperty(BuilderContent.prototype, "data", {
        get: function () {
            var content = ((this.props.inline || !sdk_1.Builder.isBrowser || this.firstLoad) &&
                ...
                this.state.data;
            return exports.getContentWithInfo(content);
        },
        enumerable: true,
        configurable: true
    });
...
exports.getContentWithInfo = function (content) {
    var _a;
    if (content) {
        var cookieValue = sdk_1.builder.getCookie("builder.tests." + content.id);
