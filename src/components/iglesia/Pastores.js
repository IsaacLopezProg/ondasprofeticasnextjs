    ...
    return (
        ...
        <div className="h-auto flex flex-wrap bg-amber-400">
            <div className="basis-full md:basis-2/3">
                <div className="ml-8 md:ml-16 mr-4 my-16">
                        ...
                        <Tab.Group>
                            <Tab.List >
                                ...
                                <div className="detalle-2 mb-8">
                                    <h5 className="text-sm md:text-xl font-light my-4 max-w-max"> Podemos ayudarte por la palabra con:</h5>
                                    <div className="text-slate-500 font-light text-xs md:text-base mt-2">
                                        <p className="mt-2"> - Consejería matrimonial.</p>
                                        <p className="mt-2"> - Consejería para tus niños.</p>
                                        <p className="mt-2"> - Consejería de negocios.</p>
                                        <p className="mt-2"> - Guía Espiritual.</p>
                                        <p className="mt-2"> - Ayuda Ministerial.</p>
                                        <p className="mt-2"> - Entre otros.</p>
                                    </div>
                                    <br/>
